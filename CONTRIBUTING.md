...
4. Open a PR from your fork to `Mornante/ProxmoxVE/devdev`
...
```bash
dev_mode="trace,keep" bash -c "$(curl -fsSL https://raw.githubusercontent.com/Mornante/ProxmoxVE/devdev/ct/myapp.sh)"
```
