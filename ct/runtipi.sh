...
ADDON_SCRIPT="https://raw.githubusercontent.com/Mornante/ProxmoxVE/devdev/tools/addon/runtipi.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/Mornante/ProxmoxVE/devdev/tools/addon/runtipi.sh)"
MIGRATION_EOF
