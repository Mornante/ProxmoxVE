...
ADDON_SCRIPT="https://raw.githubusercontent.com/Mornante/ProxmoxVE/main/tools/addon/komodo.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/Mornante/ProxmoxVE/main/tools/addon/komodo.sh)"
MIGRATION_EOF
