...
ADDON_SCRIPT="https://raw.githubusercontent.com/Mornante/ProxmoxVE/devdev/tools/addon/dockge.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/Mornante/ProxmoxVE/devdev/tools/addon/dockge.sh)"
MIGRATION_EOF
