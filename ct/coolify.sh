#!/usr/bin/env bash
source <(curl -fsSL https://raw.githubusercontent.com/Mornante/ProxmoxVE/devdev/misc/build.func)
...
ADDON_SCRIPT="https://raw.githubusercontent.com/Mornante/ProxmoxVE/devdev/tools/addon/coolify.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/Mornante/ProxmoxVE/devdev/tools/addon/coolify.sh)"
MIGRATION_EOF
