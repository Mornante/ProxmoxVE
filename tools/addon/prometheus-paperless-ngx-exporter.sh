...
source <(curl -fsSL https://raw.githubusercontent.com/Mornante/ProxmoxVE/devdev/misc/core.func)
source <(curl -fsSL https://raw.githubusercontent.com/Mornante/ProxmoxVE/devdev/misc/tools.func)
source <(curl -fsSL https://raw.githubusercontent.com/Mornante/ProxmoxVE/devdev/misc/error_handler.func)
source <(curl -fsSL https://raw.githubusercontent.com/Mornante/ProxmoxVE/devdev/misc/api.func) 2>/dev/null || true
...
type=update bash -c "$(curl -fsSL https://raw.githubusercontent.com/Mornante/ProxmoxVE/devdev/tools/addon/prometheus-paperless-ngx-exporter.sh)"
UPDATEEOF
