...
source <(curl -fsSL https://raw.githubusercontent.com/Mornante/ProxmoxVE/main/misc/tools.func)
...
type=update bash -c "$(curl -fsSL https://raw.githubusercontent.com/Mornante/ProxmoxVE/main/tools/addon/prometheus-paperless-ngx-exporter.sh)"
UPDATEEOF
