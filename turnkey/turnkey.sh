...
source <(curl -fsSL https://raw.githubusercontent.com/Mornante/ProxmoxVE/devdevmisc/api.func)
source <(curl -fsSL https://raw.githubusercontent.com/Mornante/ProxmoxVE/devdevmisc/core.func)
source <(curl -fsSL https://raw.githubusercontent.com/Mornante/ProxmoxVE/devdevmisc/error_handler.func)
load_functions
catch_errors
